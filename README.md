...
🖐️ 人間工学的に操作しやすいUI / Ergonomic UI

撮影・解析などの主要ボタンを 画面中央付近の「ボタン帯」 に配置（親指が届きやすい）

結果が表示されても ボタン帯を隠さない（結果エリアのみスクロール）

ボタン文字・タップ領域を少し大きく して押しやすく調整
...
※結果が増えても ボタン帯は固定され、操作が隠れない ようになっています。
...
右上メニュー → アプリをインストール（または「ホーム画面に追加」）

スクリーンショット / Screenshot

![screenshot](/screenshot1.png)

※主要ボタンを画面中央付近にまとめ、片手（親指）でも押しやすいように調整しています。結果が出てもボタンが隠れません。
